...
public class FuserPanel extends javax.swing.JPanel implements DBConfigListener {
    ...
    public static void registerTransformations() {
        ...
        meta_transformations.put("Keep Left","Keep Left");
        meta_transformations.put("Keep Right","Keep Right");
        meta_transformations.put("Keep Both","Keep Both");
        meta_transformations.put("Keep Concatenated Left","Keep Concatenated Left");
        meta_transformations.put("Keep Concatenated Right","Keep Concatenated Right");
        meta_transformations.put("Keep Concatenated Both","Keep Concatenated Both");
        meta_transformations.put("Keep Flattened Left","Keep Flattened Left");
        meta_transformations.put("Keep Flattened Right","Keep Flattened Right");
