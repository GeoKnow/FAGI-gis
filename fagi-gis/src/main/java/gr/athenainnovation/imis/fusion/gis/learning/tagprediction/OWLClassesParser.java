...
public class OWLClassesParser {
    //private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(OWLClassesParser.class);
    private final Map<String, String> mappings;
    private final Map<String, Integer> mappingsWithIDs;
    private final Map<Integer, String> idsWithMappings;
    
    public OWLClassesParser(){    
