...
public abstract class AbstractFusionTransformation {
    ...
    public static final int STD_SRID = 3786;//4326;
    
    public abstract void fuseCluster(final Connection connection) throws SQLException;
    ...
    /**
     * 
     * @return an integer identifier for this transformation
     */
    public abstract int getIntegerID(); 
    
    protected int insertFusedGeometryCollection(final Connection connection, final String nodeA, final String nodeB, final String geomA, String geomB) throws SQLException {
        ...
        try (final PreparedStatement statement = connection.prepareStatement(query)) {            
            ...
            String fusedGeometry = "GEOMETRYCOLLECTION("+geomA+","+geomB+")";
            System.out.println("Result Geo : "+fusedGeometry);
