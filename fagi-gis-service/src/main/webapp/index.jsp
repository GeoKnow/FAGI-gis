                                                                                            ...
                                                                                            <div id="fg-user-panel">
                                                                                                <form id="fg-user-div" name="user_input"><p />
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <input id="fg-user-mail" type="text" name="u_mail" value="n@in.gr" class="form-control">
                                                                                                    </div>
                                                                                                    <div class="form-group">
                                                                                                        <label for="fg-user-name">Username:</label>
                                                                                                        <input id="fg-user-name" type="text" name="u_name" value="n" class="form-control">
                                                                                                    </div>
                                                                                                    <div class="form-group">
                                                                                                        <label for="fg-user-pass">Password:</label>
                                                                                                        <input id="fg-user-pass" type="password" name="u_pass" value="n" class="form-control">
                                                                                                    </div>
