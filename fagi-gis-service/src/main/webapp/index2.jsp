...
<head>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css">
    ...
    <body>
        ...
        <div class="tooltip" id="transformPopupMenu">
...
<datalist id="datalist1"></datalist>
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center; padding-right: 20px;" align="left" valign="bottom"><div class="" style="display:inline-block;"><label><input id="domA" name="d_dom" value="true" type="checkbox" checked="true"/>A</label></div></td>
                        <td style="text-align: center; padding-right: 20px;" align="left" valign="bottom"><div class="" style="display:inline-block;"><label><input id="domB" type="checkbox" />B</label></div></td>                                  
                    </tr>
                </tbody>
            </table>
  ...
  <input id="spinner" name="value">
            ...
            <div id="clusteringPanel">
                    Connecting Vector Length: <div id="connVecLenCheck">
  <input type="checkbox" id="check1"><label for="check1">YES</label>
  <input type="checkbox" id="check2"><label for="check2">NO</label>
</div>
                    Connecting Vector Direction: <div id="connVecDirCheck">
  <input type="checkbox" id="check3"><label for="check3">YES</label>
  <input type="checkbox" id="check4"><label for="check4">NO</label>
</div>
                    Number of CLusters: <div id="slider"></div>
               <input id="clusterButton" type="submit" value="PerformClustering" style="float:right" onclick="return true;"/>
            </div>
  </div>
